...
import comAu549640_ErdaNazCecilliaKocamanBal_MAD22_spring_assignment2.example.au549640_erdanazcecilliakocamanbal_a2.viewmodel.FactoryViewModel;
...
public class SearchActivity extends AppCompatActivity  implements SearchAdapter.ISearchClickListener {
    ...
    public void onDrinkClicked(int index) {
        ...
        vm.addDrink(d);
        Toast.makeText(SearchActivity.this, "Drink added to library!", Toast.LENGTH_SHORT).show();
        finish();
    }
}