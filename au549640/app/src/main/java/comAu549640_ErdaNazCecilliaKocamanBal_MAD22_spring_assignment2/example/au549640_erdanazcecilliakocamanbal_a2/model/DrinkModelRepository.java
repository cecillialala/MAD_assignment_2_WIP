...
* The check on if the drink is there already has been made with guidance of Mahmoud
* */
...
public class DrinkModelRepository {
    ...
    public ListenableFuture<DrinkModel> findDrink(String drinkName) { return db.drinkDAO().findDrink(drinkName);}
